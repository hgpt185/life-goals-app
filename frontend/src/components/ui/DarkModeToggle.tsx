...
const DarkModeToggle: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      />
      <span className="absolute left-0 right-0 flex justify-between px-1.5">
        {/* Sun icon */}
        <svg
          className={`h-3 w-3 ${isDarkMode ? 'text-gray-400' : 'text-yellow-500'}`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
        ...
        {/* Moon icon */}
        <svg
          className={`h-3 w-3 ${isDarkMode ? 'text-white' : 'text-gray-400'}`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
